...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://solwearth.com/products/se-1h',
  },
}

export default function SE1HPage() {
  const specifications = [
    { label: "Capacity", value: "1000 KG (1 Ton)" },
  ...
  const productSchema = {
    ...
    "image": "https://solwearth.com/images/machine/SE-1H-front-view.png",
    "brand": {
      "@type": "Brand",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": "SE 1H",
        "item": "https://solwearth.com/products/se-1h"
      }
    ]
  }
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">SE 1H Key Features</h2>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">SE 1H Ideal For</h2>
      ...
      <section className="py-16 bg-green-600">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Get Your SE 1H Waste Converter Today</h2>
